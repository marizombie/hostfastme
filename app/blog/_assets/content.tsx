...
// import mariImg from "@/app/blog/_assets/images/authors/mari.png";
...
export const categories: categoryType[] = [
  {
    ...
    description:
      "Here are the latest features I've added to HostFast.me.",
    // A short version of the description above, only displayed in the <Header /> on mobile. Up to 60 characters.
    descriptionShort: "Latest features added to HostFast.me.",
  },
  {
    ...
    description:
      "Learn how to set up server on AWS or GCP with these step-by-step tutorials. I'll show you how to do it fast and simple.",
    descriptionShort:
      "Learn how to cook you webserver with HostFast.me guides",
  },
];
...
export const authors: authorType[] = [
  {
    ...
    slug: authorSlugs.mari,
    // The name to display in the author's bio. Up to 60 characters.
    name: "Maryna",
    // The job to display in the author's bio. Up to 60 characters.
    job: "Maker of HostFast.me",
    // The description of the author to display in the author's bio. Up to 160 characters.
    description:
      "Maryna is a developer and an aspiring entrepreneur. Currently building 3 startups.",
      //Currently building ....
    ...
    socials: [
      {
        ...
        url: "https://twitter.com/marinklokova",
      },
      {
        name: socialIcons.linkedin.name,
        icon: socialIcons.linkedin.svg,
        url: "https://www.linkedin.com/in/maryna-klokova/",
      },
      // {
